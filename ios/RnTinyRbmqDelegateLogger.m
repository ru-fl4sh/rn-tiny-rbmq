...
- (void)channel:(id<RMQChannel>)channel error:(NSError *)error {
    ...
    [RnTinyRbmqEventEmitter emitEventWithName:@"RnTinyRbmqEvent" body:@{@"name": @"error", @"type": @"channel",  @"code": [NSString stringWithFormat:@"%ld", (long)error.code], @"description": [error localizedDescription]}];
}
...
- (void)connection:(RMQConnection *)connection disconnectedWithError:(NSError *)error {
    ...
    [RnTinyRbmqEventEmitter emitEventWithName:@"RnTinyRbmqEvent" body:@{@"name": @"error", @"type": @"disconnected",  @"code": [NSString stringWithFormat:@"%ld", (long)error.code], @"description": [error localizedDescription]}];
}
...
- (void)connection:(RMQConnection *)connection failedToConnectWithError:(NSError *)error {
    ...
    [RnTinyRbmqEventEmitter emitEventWithName:@"RnTinyRbmqEvent" body:@{@"name": @"error", @"type": @"failedtoconnect", @"code": [NSString stringWithFormat:@"%ld", (long)error.code], @"description": [error localizedDescription]}];
